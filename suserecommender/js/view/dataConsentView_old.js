var DataConsentView = function ( model, container ){
	...
	var emailText			= $( '<p style="font-weight:bold;">Om in aanmerking te komen voor de verloting van één van vijf Bol.com-waardebonnen t.w.v. €20,- hebben we uw e-mailadres nodig</p>');
	var emailSend			= $( '<p><input id="box1" type="checkbox" style="margin-bottom:10px"> Ja, stuur mij de gekozen maatregelen per e-mail</p>');
