var InformedConsentView = function(model, container){
	...
	var p2							= $("<p>Onder de deelnemers die het onderzoek afronden, verloten we tevens 5x een Bol.comwaardebon t.w.v. €10,-.</p></br>");
	var startButton	 		= $("<center><a class='btn btn-default btn-lg' role='button' style='margin-left:auto;font-size: 18px; padding-left:2%; padding-right:2%; ; display:inline-block;'>Klik hier om verder te gaan</a></center></br>");
	var p3							= $("<p></p> <p></p>");
